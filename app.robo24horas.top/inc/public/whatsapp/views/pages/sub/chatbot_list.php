        ...
        <h4 class="mb-4"><?php _e('Chatbot') ?>
            <div class="option float-right position-relative">
                <div class="dropdown d-inline-block">
                    <a href="#" class="btn btn-info btn-sm p-t-1 p-r-5 p-l-5 p-b-1 dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Option</a>
                    <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 28px, 0px);">
                        <a class="dropdown-item wa-action-item wa-open-content" data-result-content="wa-content" href="/whatsapp/get/chatbot_export">Exportar</a>
                        <a class="dropdown-item wa-action-item wa-open-content" data-result-content="wa-content" href="/whatsapp/get/chatbot_import">Importar</a>
                        <a class="dropdown-item wa-action-item wa-open-content" data-result-content="wa-content" href="/whatsapp/get/chatbot_duplicate">Duplicar</a>
                    </div>
                </div>
