			...
			<div class="fm-box">
				<a data-fancybox="gallery" href="<?php _e(BASE . $row->file) ?>">
					<div class="fm-media">
						...
						<?php } else if (is_type('video', $row->extension)) { ?>
						...
						<?php } else { ?>
							<a data-fancybox="gallery" href="<?= $row->file ?>">
								<div class="fm-media" 
									style="flex-direction: column; align-items: center; 
										justify-content: center; background-position: center center; 
										background-size: 80%; background-repeat: no-repeat; top: 0;
										background-image: url(&quot;assets/types/<?= $row->extension ?>.png&quot;);">
								</div>
								<p style="color: black; bottom: -10px; position: absolute; width: 100%;"><?= $row->name ?></p>
							</a>
						<?php } ?>
					</div>
				</a>
